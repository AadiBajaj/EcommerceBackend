...
app.post("/upload", upload.single('product'), (req, res) => {
    res.json({
        success: 1,
        image_url: `https://ecommercebackend-s6d7.onrender.com/images/${req.file.filename}`
...
app.post("/addproduct", async (req, res) => {
    ...
    const product = new Product({
        ...
        detailed_category: req.body.detailed_category, 
    });
    console.log(product);
    await product.save();
    console.log("Saved");
...
app.post('/removefromcart', fetchuser, async (req, res) => {
	console.log("Remove Cart Fetched");
    let userData = await Users.findOne({_id:req.user.id});
